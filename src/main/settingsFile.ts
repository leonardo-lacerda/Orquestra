...
const SETTINGS_SCHEMA: Record<keyof AppSettings, string> = {
  ...
  orchestrationDefaultWorkerKind: 'string',
  orchestrationDefaultWorkerAgent: 'string',
  orchestrationDefaultAgentCommand: 'string',
  orchestrationTaskSplitStrategy: 'string',
  orchestrationContextPolicy: 'string',
  orchestrationReviewPolicy: 'string',
  orchestrationOnWorkerDone: 'string',
  orchestrationWorkerNamePrefix: 'string',
  orchestrationPermissionMode: 'string',
  ...
  orchestrationDispatchMode: 'string',
  orchestrationAutoDrainQueue: 'boolean',
  linkedContextDefaultMode: 'string',
